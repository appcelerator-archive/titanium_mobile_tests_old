...
// in simulator we redefine to format for UICompositeLayout Developer console
...
{\
	NSString * exceptionName = [@"org.uicompositelayout." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uicompositelayout";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIUICompositeLayoutNativeItemNone = -1, 
	UIUICompositeLayoutNativeItemSpinner = -2,
	UIUICompositeLayoutNativeItemProgressBar = -3,
	
	UIUICompositeLayoutNativeItemSlider = -4,
	UIUICompositeLayoutNativeItemSwitch = -5,
	UIUICompositeLayoutNativeItemMultiButton = -6,
	UIUICompositeLayoutNativeItemSegmented = -7,
	
	UIUICompositeLayoutNativeItemTextView = -8,
	UIUICompositeLayoutNativeItemTextField = -9,
	UIUICompositeLayoutNativeItemSearchBar = -10,
	
	UIUICompositeLayoutNativeItemPicker = -11,
	UIUICompositeLayoutNativeItemDatePicker = -12,
	
	UIUICompositeLayoutNativeItemInfoLight = -13,
	UIUICompositeLayoutNativeItemInfoDark = -14,
	
	UIUICompositeLayoutNativeItemDisclosure = -15,
	
	UIUICompositeLayoutNativeItemContactAdd = -16
};
