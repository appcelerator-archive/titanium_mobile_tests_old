...
//@interface UICompositeLayoutObject : NSObject
//@end

@interface UICompositeLayoutObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UICompositeLayoutObject class]])
		{
			for (NSString *key in [[(UICompositeLayoutObject*)o modules] allKeys])
			{
